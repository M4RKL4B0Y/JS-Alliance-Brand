...
function addCustomerName() {
    ...
    let header = document.getElementById('Ron Swanson')
    ...
    let introHeader = document.getElementById('Alliance')
...
function toggleColors() {
    ...
    let el = document.querySelectorAll('.tm-blue-rect');

    for (i = 0; i < el.length; ++i) {
        el[i].classList.add('tm-blue-rect');
        el[i].classList.remove('tm-blue-rect');
    }
};
